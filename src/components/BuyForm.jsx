...
const BuyForm = () => {
    const { connectedAccount, accountEthBalance, accountDhoBalance, buyTokens, connectWallet } = useContext(ConnectionContext);
    ...
    return (
        <div className="flex flex-col w-full md:w-80 lg:w-80 py-5 px-3 space-y-5 text-white">
            ...
            <div className="flex flex-col items-center">
                {connectedAccount ? (
                    <button type="button" onClick={() => buyTokens(input)} className="flex rounded-full justify-center px-6 py-1 cursor-pointer bg-gradient-to-r from-purple-900 to-blue-500 shadow-sm">
